                ...
                <div class="px-4 py-6 sm:p-8">
                    ...
                    <div class="mt-8 pt-8 border-t border-slate-900/10">
                        <form action="/profile/assign-manager" method="POST">
                            ...
                            <?php if (!empty($manager)): ?>
                                <div class="mt-4 rounded-md bg-green-50 p-4">
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            <h3 class="text-sm font-medium text-green-800">Conectado ao Gestor</h3>
                                            <div class="mt-2 text-sm text-green-700">
                                                <p>Nome: <span class="font-semibold"><?= htmlspecialchars($manager['name']) ?></span></p>
                            ...
                            <?php else: ?>
                                <p class="mt-2 text-sm text-slate-500">Você ainda não possui um gestor vinculado.</p>
                            <?php endif; ?>
                        </form>
                    </div>
                </div>
